            ...
            try {
                return (
                    <Col
                        ...
                        className={this.props.className || 'h-100'}
                    >
                        <div style={this.props.style || {}} className={'p-1 '}>
                            ...
                            >
                                ...
                                {this.props.settings?.hideTokenId !== true ? (
                                    <>
                                        <span className="badge bg-dark fs-5 mt-2 ms-2 text-center">
                                            <span
                                                style={{
                                                    fontSize: 10,
                                                    paddingRight: 6,
                                ...
                                this.props?.settings?.hidePathName !== true ? (
                                    <>
                                        <br />
                                        <span className="badge bg-dark fs-5 ms-2 mt-2">
                                            {cutLongString(
                                                pathSettings.name,
                                                this.props?.settings
                                                    ?.pathNameCutLength || 16
                                            )}
                                        </span>
                                    </>
                                ) : (
                                ...
                                token?.tokenId !== undefined ? (
                                    <>
                                        <br />
                                        <span className="badge bg-info fs-6 me-2 ms-2 mt-2">
                                ...
                                true ? (
                                    <>
                                        ...
                                        {!hasDestination(token, 0) ? (
                                            <span className="badge bg-danger fs-6 me-2 ms-2 mt-2">
                                                ❌Wallet
                                            </span>
                                        ) : (
                                            <span className="badge bg-success fs-6 me-2 ms-2 mt-2">
                                                ✔️ Wallet
                                            </span>
                                        )}

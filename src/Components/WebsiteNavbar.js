...
class WebsiteNavbar extends Component {
    ...
    componentDidMount() {
        // Essentially hits the render function every second to detect navbar changes
        // dumb method but hey it works :)
        const func = () => {
        ...
        interval = setInterval(
            func,
            Config.settings.navbarRefreshInterval * 1000
        );
    }
        ...
        return (
            <>
                {!this.state.hideNavbar && !controller.isWalletValid ? (
                    <>
                        <Alert variant="warning" className="m-0 p-0 bg-danger">
                ...
                <Navbar
                    ...
                    style={{ backgroundColor: '#280f91' }}
                    hidden={this.state.hideNavbar}
                >
                    <Container fluid>
                        <Navbar
                            href="/"
                            className="d-sm-none d-md-block d-none fs-5 force-white"
                        >
                            <span
                                className="badge bg-light me-2"
                                style={{
                                    fontSize: 12,
                                }}
                            >

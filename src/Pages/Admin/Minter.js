            ...
            <>
                <Container className="p-5" fluid>
                    {this.state.isReady && !this.state.loading ? (
                        <>
                            <Row className="force-white">
                                <Col>
                                    <h1 className="display-1 header-text textGold">
                                        💎 Admin Minter
                                    </h1>
                                    <p className="fs-5">
                                        Create new{' '}
                                        {Resources.projectTokenPlural()} here.
                                    </p>
                                </Col>
                            </Row>
                            <Row className="mt-4">
                            ...
                            <Row className="mt-4">
                                <Col>
                                    <Card body>
                                        <p className="fs-2">🏷️ Information</p>
                                        <hr />
                                        <Row className="gap-2">
                                            <Col>

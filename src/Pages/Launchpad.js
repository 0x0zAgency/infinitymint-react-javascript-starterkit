...
class Launchpad extends Component {
    ...
    async deployContract(link, args = []) {
        ...
        try {
            console.log(this.parseArgs(args));
            ...
            <>
                {this.state.loading ? (
                    ...
                    <Container fluid className="p-5">
                        <Row>
                            <Col>
                                <h1 className="display-1 text-center mb-4 mt-2">
                                    <span className="zombieTextRed header-text textGold">
                                        🚀 Token Launchpad
                                    </span>
                                </h1>
                                <Alert variant="success">
                                    <h3 className="text-center mt-2">
                                        ...
                                        attaching INFINITY💎GEMS.
                                    </h3>
                                    <p className="fs-4 text-center">
                                        These 💎 are expansions that add utility
                                        and features to your tokens. Plug-ins
                                        that unleash the magic and amazing power
                                        of Web3.
                                    </p>
                                </Alert>
                            </Col>
                            ...
                            <Row className="mt-4">
                                <Col>
                                    <Box
                                        ...
                                        className="fs-3"
                                    >
                                        Success! Please try reloading this token
                        ...
                        <Row className="mt-4" hidden={!this.state.isValid}>
                            <Col>
                                <Card>
                                    <Card.Header className="fs-2 text-white">
                                        Available INFINITY💎GEMS{' '}
                                                        ...
                                                        <Col key={index}>
                                                            <Card className="h-100">
                                                                ...
                                                                <Card.Body>
                                                                    ...
                                                                    undefined ? (
                                                                        <div
                                                                            className="mb-4 bg-light text-black rounded p-2 mb-2"
                                                                            style={{
                                                                                height: 146,
                                                                                overflowY:
                                                                                    'auto',
                        ...
                        <Row
                            className="mt-2"
                            hidden={!this.state.isValid || this.state.loading}
                        >
                            <Col>
                                <GasMachine />
                            </Col>

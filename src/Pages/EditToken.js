                    ...
                    <Container fluid className="p-4">
                        <Row className="mb-0">
                            <h1 className="display-1 text-center mb-4 mt-2">
                                <span className="zombieTextRed  text-white">
                                    {resources.$.UI.Action.EditingToken}
                                </span>
                            </h1>
                        </Row>
                        ...
                        <Row className="gy-2">
                            <Col>
                                ...
                                >
                                    <p
                                        className="fs-2 mb-0 force-white"
                            ...
                            <Col>
                                ...
                                >
                                    <div className="d-grid gap-2">
                                        ...
                                        >
                                            {resources.$.UI.Action.RefreshToken}
                                        </Button>
                                        <h4 className="ms-2 mt-1 mb-0 mt-3">
                                            🕸 Web3
                                        </h4>
                                        ...
                                        >
                                            {resources.$.UI.Action.OpenSeaLink}
                                        </Button>
                                        <Button
                                            variant="success"
                                            size="sm"
                                        ...
                                        <Button
                                            ...
                                            disabled
                                        >
                                            {resources.$.UI.Action.TwitterLink}
                                        </Button>
                                        <Button
                                            variant="success"
                                            size="sm"
